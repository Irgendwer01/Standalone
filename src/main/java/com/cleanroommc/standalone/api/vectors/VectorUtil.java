...
public class VectorUtil {
     ...
     */
    public static double distanceFromPointToPlane(@Nonnull Vector4d plane, @Nonnull Vector3d point) {
        Vector4d newPoint = new Vector4d(point.x, point.y, point.z, 1);
        return plane.dot(newPoint);
    }

    public static void computePlaneEquation(@Nonnull Vector4d a, @Nonnull Vector4d b, @Nonnull Vector4d c, Vector4d result) {
        computePlaneEquation(new Vector3d(a.x, a.y, a.z), new Vector3d(b.x, b.y, b.z), new Vector3d(c.x, c.y, c.z), result);
    }

    @Nonnull
    public static Vector3d clamp(@Nonnull Vector3d v, double min, double max) {
     ...
     * @param b      vector b.
     * @param c      vector c.
     * @param result the result (A,B,C,D) of plane equation.
     */
    public static void computePlaneEquation(@Nonnull Vector3d a, @Nonnull Vector3d b, @Nonnull Vector3d c, @Nonnull Vector4d result) {
     ...
     * @param point the point.
     */
    public static void projectPointOntoPlane(@Nonnull Vector4d plane, Vector4d point) {
     ...
     */
    @Nullable
    public static Vector3d computeIntersectionBetweenPlaneAndLine(@Nonnull Vector4d plane, Vector3d pointInLine, Vector3d lineDirection) {
     ...
     */
    public static void computeRayForPixel(@Nonnull Rectangle vp, Matrix4d ipm, @Nonnull Matrix4d ivm, int x, int y, Vector3d eyeOut, @Nonnull Vector3d normalOut) {
     ...
     */
    public static void setNearFarOnPerspectiveProjectionMatrix(@Nonnull Matrix4d projMat, double near, double far) {
    ...
    public static Vector3d preMultiply(@Nonnull Vector3d v, Matrix4d mat) {
     ...
     */
    public static double distance(@Nonnull Vector3d from, Vector3d to) {
     ...
     */
    public static double distanceSquared(@Nonnull Vector3d from, Vector3d to) {
     ...
     */
    public static void getVectorsForMatrix(@Nonnull Matrix4d matrix, @Nonnull Vector3d upVecOut, @Nonnull Vector3d sideVecOut, @Nonnull Vector3d lookVecOut) {
    ...
    @Nonnull
    public static Vector3d getUpFromMatrix(@Nonnull Matrix4d matrix) {
