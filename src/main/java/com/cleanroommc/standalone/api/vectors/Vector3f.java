...
public class Vector3f {
    ...
    public Vector3f(@Nonnull Vector3d other) {
    ...
    public void set(@Nonnull Vector3f vec) {
        x = vec.x;
        y = vec.y;
        z = vec.z;
    }

    public void add(@Nonnull Vector3f vec) {
        x += vec.x;
        y += vec.y;
        z += vec.z;
    }

    public void add(@Nonnull Vector3d vec) {
        x += vec.x;
        y += vec.y;
        z += vec.z;
    }
    ...
    public void sub(@Nonnull Vector3f vec) {
        x -= vec.x;
        y -= vec.y;
        z -= vec.z;
    }
