...
public class Matrix4d {
    ...
    public Matrix4d(@Nonnull float[] arr) {
        m00 = arr[0];
        m01 = arr[1];
        m02 = arr[2];
        m03 = arr[3];
    ...
    public Matrix4d(@Nonnull double[] arr) {
        m00 = arr[0];
        m01 = arr[1];
        m02 = arr[2];
        m03 = arr[3];
    ...
    public Matrix4d(@Nonnull FloatBuffer modelview) {
        m00 = modelview.get(0);
        m01 = modelview.get(1);
        m02 = modelview.get(2);
        m03 = modelview.get(3);
    ...
    public void set(@Nonnull Matrix4d other) {
        m00 = other.m00;
        m01 = other.m01;
        m02 = other.m02;
        m03 = other.m03;
    ...
    public void set(@Nonnull double[] values) {
        m00 = values[0];
        m01 = values[1];
        m02 = values[2];
        m03 = values[3];
    ...
    public void getTranslation(@Nonnull Vector3d trans) {
        trans.x = m03;
        trans.y = m13;
        trans.z = m23;
    }

    public void setTranslation(@Nonnull Vector3d trans) {
        m03 = trans.x;
        m13 = trans.y;
        m23 = trans.z;
    }
    ...
    public void transform(@Nonnull Vector3d vec) {
    ...
    public void transform(@Nonnull Vector4d vec) {
    ...
    public void transformNormal(@Nonnull Vector3d normal) {
    ...
    public void mul(@Nonnull Matrix4d m) {
